...
def generate_ai_response(user_message: str) -> str:
    if is_email_content(user_message):
        return "I've analyzed your email. It appears to be a professional communication. Would you like me to help draft a response or identify any potential issues?"
    else:
        return "I'm here to help you analyze emails. Please paste an email content or ask me specific questions about email analysis."
